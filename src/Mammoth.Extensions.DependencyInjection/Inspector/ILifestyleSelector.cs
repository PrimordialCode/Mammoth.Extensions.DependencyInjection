...
namespace Mammoth.Extensions.DependencyInjection.Inspector
{
	...
	public interface ILifestyleSelector
	{
		...
		/// </summary>
		/// <param name="configureAction">Action used to configure each service that will be registered,
		...
		ILifestyleSelector Configure(Action<ServiceRegistration, Type> configureAction);
